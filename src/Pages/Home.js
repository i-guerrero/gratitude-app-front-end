  ...
  return (
    <div className="Home">
      <Container>
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRR_EdjUMsSxI0bRVUvnGUuJUPw5LZMQzClNw&usqp=CAU" />
        <p>
        ...
        <br></br> <br></br>
        <img src="https://stenzelclinical.com/wp-content/uploads/2017/06/Search-for-Joy-and-Happiness.jpg"></img>
      </Container>
    </div>
  );
}
